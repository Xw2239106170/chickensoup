...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__7AB8AA4",
    appName: "chicken-soup",
    appVersion: "1.0.0",
    appVersionCode: "100",
  ...
  list: [
    {
      ...
      iconPath: "static/tabbar/noodle.png",
      selectedIconPath: "static/tabbar/noodle-h.png"
    },
    {
      text: "我的",
      pagePath: "pages/self/self",
      iconPath: "static/tabbar/self.png",
      selectedIconPath: "static/tabbar/self-h.png"
    }
  ]
};
const globalStyle = {
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.32.1",\n        "192.168.113.1",\n        "192.168.80.1",\n        "172.23.170.77"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/LenovoSoftstore/HBuilderX.4.0.2024012711-alpha/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), T = I('[{"provider":"aliyun","spaceName":"uni-app-demo","spaceId":"mp-339600a7-3daf-4731-809f-df53cd041b7e","clientSecret":"ExCjbw5ovFoWWTl6ckmP/g==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__7AB8AA4";
} catch (e2) {
